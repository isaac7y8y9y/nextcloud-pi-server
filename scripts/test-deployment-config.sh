...
! grep -q '@NEXTCLOUD_' "$TEST_DIR/rendered/caddy/Caddyfile" "$TEST_DIR/rendered/docker-compose.yml" "$TEST_DIR/rendered/systemd/nextcloud.service" "$TEST_DIR/rendered/storage/fstab.nextcloud"

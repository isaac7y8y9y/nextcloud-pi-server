...
render_file "$REPOSITORY_ROOT/systemd/nextcloud-background-jobs.service" "$output_dir/systemd/nextcloud-background-jobs.service"
render_file "$REPOSITORY_ROOT/systemd/nextcloud-background-jobs.timer" "$output_dir/systemd/nextcloud-background-jobs.timer"
...
render_file "$REPOSITORY_ROOT/systemd/nextcloud-pi-background-jobs" "$output_dir/launcher/nextcloud-pi-background-jobs"
...
chmod 700 "$output_dir/launcher/nextcloud-pi-background-jobs"
